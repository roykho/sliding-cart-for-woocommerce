...
class Floating_Cart_For_WooCommerce_Cart {
	...
	public function load_scripts() {
		...
		wp_enqueue_script( 'floating-cart-for-woocommerce-glide-scripts', plugins_url( 'vendor/glide/glide.min.js', dirname( __FILE__ ) ), null, '3.5.2', true );
		...
		wp_enqueue_style( 'floating-cart-for-woocommerce-glide-styles', plugins_url( 'vendor/glide/css/glide.core.min.css', dirname( __FILE__ ) ), null, '3.5.2' );
